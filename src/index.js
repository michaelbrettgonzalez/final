...
var base = Rebase.createClass({
  apiKey: "AAIzaSyBW2vPQU64o8qHGsLfu9cYHZ5PXC4rxwwk",   // replace with your Firebase application's API key
  databaseURL: "https://new-final-project.firebaseio.com/", // replace with your Firebase application's database URL
})
    ...
    return (
      <div className="header row">
        ...
        <div className="hello col-sm-3 text-center">
          <h2>Hey there you sexy beast!</h2>
        </div>
      </div>
    )
  }
